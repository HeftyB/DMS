...
//                randomContactInfo(),"55555599", JobTitle.SERVICE_WRITER, Date.from(Instant.now()));
//
...
//
//        String payStartDate6 = "2024-09-29";
//        String payEndDate6 = "2024-10-12";
//        newPayPeriodFromString(payStartDate6, payEndDate6, sdf);
//
//
...
//        new ServiceMenuItem("OIL & FILTER CHANGE", 2),
//        new ServiceMenuItem("ENGINE AIR FILTER REPLACEMENT", 1),
//        new ServiceMenuItem("CABIN AIR FILTER REPLACEMENT", 1),
//        new ServiceMenuItem("TIRE ROTATION", 2),
//        new ServiceMenuItem("TIRE REPAIR", 2),
//        new ServiceMenuItem("COOLANT CHECK", 2),
//        new ServiceMenuItem("COOLANT FLUSH", 2),
//        new ServiceMenuItem("LIGHT BULB REPLACEMENT", 2),
//        new ServiceMenuItem("CHECK OUTER BRAKE PADS", 1),
//        new ServiceMenuItem("REPLACE BRAKE PADS", 4),
//        new ServiceMenuItem("REPLACE BRAKE PADS & ROTORS", 6),
//        new ServiceMenuItem("BRAKE FLUID FLUSH", 3),
//        new ServiceMenuItem("BATTERY & ALTERNATOR CHECK", 1),
//        new ServiceMenuItem("BATTERY REPLACEMENT", 2),
//        new ServiceMenuItem("STARTER CHECK", 2),
//        new ServiceMenuItem("GENERAL INSPECTION(FLUIDS, BELTS & HOSES)", 2),
//        new ServiceMenuItem("SERPENTINE BELT REPLACEMENT", 2),
//        new ServiceMenuItem("TUNE UP", 6),
//        new ServiceMenuItem("SPARK PLUG REPLACEMENT", 3),
//        new ServiceMenuItem("IGNITION COIL REPLACEMENT", 2),
//        new ServiceMenuItem("OTHER", 4)
//    };
//
